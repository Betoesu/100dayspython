...
with open("./Input/Names/invited_names.txt") as names_file: #este comando abre o nome dos convidados 
    names = names_file.readlines() #este comando le tudo como uma lista

with open("./Input/Letters/starting_letter.txt") as letter_file: # Aqui eu abro a carta ainda nao mudada
    ...
    with open(f"./output/ReadyToSend/letter_to_{stripped_name}.docx", mode="w") as letter: # Aqui eu levo o diretório para ReadyToSend e crio o arquivo letter_to_nome do convidadado
